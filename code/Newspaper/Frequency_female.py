inputfile = open("Data/Grouped/Female/female.txt","r",encoding="utf-8")
...
outputfile = open("Graph/Female_x_y.txt","w",encoding="utf-8")
outputfiledate = open("Data/Grouped/Female/Female_x_y_date.txt","w",encoding="utf-8")
